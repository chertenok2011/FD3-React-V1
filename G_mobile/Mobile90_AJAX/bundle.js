...
_reactDom2.default.render(_react2.default.createElement(_MobileCompany2.default, null), document.getElementById('container'));
...
var MobileCompany = function (_React$PureComponent) {
  ...
  function MobileCompany(props) {
    ...
    var _this = _possibleConstructorReturn(this, (MobileCompany.__proto__ || Object.getPrototypeOf(MobileCompany)).call(this, props));
    ...
    _this.loadData = function () {
      ...
      (0, _isomorphicFetch2.default)("http://fe.it-academy.by/TestFetch.php", {
        method: 'post',
        headers: {
        ...
        if (!response.ok) {
          var Err = new Error("fetch error " + response.status);
        ...
        _this.fetchError(error.userMessage || error.message);
      });
    };
