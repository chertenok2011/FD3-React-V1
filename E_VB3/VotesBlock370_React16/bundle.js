...
var _VotesBlock = __webpack_require__(29);
...
var answersArr = __webpack_require__(37);
...
var _reactDomFactories = __webpack_require__(10);

var _reactDomFactories2 = _interopRequireDefault(_reactDomFactories);

__webpack_require__(32);

var _VotesQuestion = __webpack_require__(33);

var _VotesQuestion2 = _interopRequireDefault(_VotesQuestion);

var _VotesAnswer = __webpack_require__(35);
...
var VotesBlock = function (_React$Component) {
  ...
  _createClass(VotesBlock, [{
    ...
    value: function render() {
      ...
      return _reactDomFactories2.default.div({ className: 'VotesBlock' }, _react2.default.createElement(_VotesQuestion2.default, { question: this.props.question }), _reactDomFactories2.default.div({ className: 'Answers' }, answersCode), this.state.workMode == 1 && this.state.selectedAnswerCode ? _reactDomFactories2.default.input({ type: 'button', value: 'проголосовать', onClick: this.vote }) : null);
    }
  }]);
...
var VotesQuestion = function (_React$Component) {
  ...
  _createClass(VotesQuestion, [{
    key: 'render',
    value: function render() {
      return _reactDomFactories2.default.div({ className: 'VotesQuestion' }, this.props.question);
    }
  }]);
  ...
  _createClass(VotesAnswer, [{
    ...
    value: function render() {
      ...
      if (this.props.workMode == 1) {
        return _reactDomFactories2.default.div(null, _reactDomFactories2.default.label({ className: 'VotesBlockAnswer' }, _reactDomFactories2.default.input({ type: 'radio', value: this.props.code, name: 'voteanswer',
          checked: this.props.selectedAnswerCode == this.props.code,
          onClick: this.answerClicked }), _reactDomFactories2.default.span(null, this.props.text), this.props.freeanswer ? _reactDomFactories2.default.input({ type: 'text', name: 'votefreeanswer', className: 'FreeAnswer',
        ...
        return _reactDomFactories2.default.div({ className: 'VotesBlockAnswer' }, _reactDomFactories2.default.span({ className: 'Count' }, this.props.count), _reactDomFactories2.default.span({ className: 'Text' }, this.props.text));
      }
    }
  }]);
