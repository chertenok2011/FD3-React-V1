...
var VotesAnswer = function (_React$Component) {
  ...
  function VotesAnswer() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = VotesAnswer.__proto__ || Object.getPrototypeOf(VotesAnswer)).call.apply(_ref, [this].concat(args))), _this), _this.componentWillReceiveProps = function (newProps) {
      if (_this.props.code == 3) console.log('componentWillReceiveProps');
    }, _this.componentWillUpdate = function () {
      if (_this.props.code == 3) console.log('componentWillUpdate');
    }, _this.componentDidUpdate = function (oldProps, oldState) {
      if (_this.props.code == 3) console.log('componentDidUpdate');
    }, _this.componentWillMount = function () {
      if (_this.props.code == 3) console.log('componentWillMount');
    }, _this.componentDidMount = function () {
      if (_this.props.code == 3) console.log('componentDidMount');
    }, _this.componentWillUnmount = function () {
      if (_this.props.code == 3) console.log('componentWillUnmount');
