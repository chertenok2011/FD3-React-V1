...
var _VotesBlock = __webpack_require__(28);
...
var answersArr = __webpack_require__(36);
...
var _VotesQuestion = __webpack_require__(32);

var _VotesQuestion2 = _interopRequireDefault(_VotesQuestion);

var _VotesAnswer = __webpack_require__(34);
...
var VotesBlock = function (_React$Component) {
  ...
  function VotesBlock() {
    ...
    }, _this.showRedQuestion = function () {
      _this.setState({ visibleQuestionNum: 1 });
    }, _this.showBlueQuestion = function () {
      _this.setState({ visibleQuestionNum: 2 });
  ...
  _createClass(VotesBlock, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement('input', { type: 'button', value: '\u043A\u0440\u0430\u0441\u043D\u044B\u0439', onClick: this.showRedQuestion }),
        _react2.default.createElement('input', { type: 'button', value: '\u0441\u0438\u043D\u0438\u0439', onClick: this.showBlueQuestion }),
        this.state.visibleQuestionNum == 1 && _react2.default.createElement(_VotesQuestion2.default, { key: 1, question: this.props.question, auxClassName: 'VotesQuestionRed' }),
        this.state.visibleQuestionNum == 2 && _react2.default.createElement(_VotesQuestion2.default, { key: 1, question: this.props.question, auxClassName: 'VotesQuestionBlue' }),
...
var VotesQuestion = function (_React$Component) {
  ...
  function VotesQuestion() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = VotesQuestion.__proto__ || Object.getPrototypeOf(VotesQuestion)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      auxClassName: _this.props.auxClassName // сработает при построении компонента (constructor+WM+DM)
    }, _this.componentWillReceiveProps = function (newProps) {
      console.log('componentWillReceiveProps');
      _this.setState({ auxClassName: newProps.auxClassName }); // сработает при обновлении компонента (WRP+WU+DU)
  ...
  _createClass(VotesQuestion, [{
    key: 'render',
    value: function render() {
      return _react2.default.createElement('input', { type: 'text', className: 'VotesQuestion ' + this.state.auxClassName, defaultValue: this.props.question });
    }
  }]);
...
VotesQuestion.propTypes = {
  question: _propTypes2.default.string.isRequired,
  auxClassName: _propTypes2.default.string.isRequired
};
