...
var VotesQuestion = function (_React$Component) {
  ...
  function VotesQuestion() {
    ...
    }, _this.newTextRef = null, _this.setNewTextRef = function (ref) {
      _this.newTextRef = ref;
    }, _this.setNewText = function () {
      if (_this.newTextRef) {
        // всегда проверяем - мало ли метод вызовется когда DOM-элемента уже нет или ещё нет?
        var newText = _this.newTextRef.value;
        _this.setState({ question: newText });
      }
    }, _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(VotesQuestion, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        null,
        _react2.default.createElement('input', { type: 'text', defaultValue: '\u043D\u043E\u0432\u044B\u0439 \u0442\u0435\u043A\u0441\u0442 \u0432\u043E\u043F\u0440\u043E\u0441\u0430', ref: this.setNewTextRef }),
        _react2.default.createElement('input', { type: 'button', value: '\u0437\u0430\u0434\u0430\u0442\u044C', onClick: this.setNewText }),
        _react2.default.createElement(
          'div',
