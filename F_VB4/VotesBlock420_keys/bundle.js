...
var VotesQuestion = function (_React$Component) {
  ...
  function VotesQuestion() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = VotesQuestion.__proto__ || Object.getPrototypeOf(VotesQuestion)).call.apply(_ref, [this].concat(args))), _this), _this.componentWillReceiveProps = function (newProps) {
  ...
  _createClass(VotesQuestion, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        { className: 'VotesQuestion ' + this.props.auxClassName },
        this.props.question
      );
    }
  }]);
