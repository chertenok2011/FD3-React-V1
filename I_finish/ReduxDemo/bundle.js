...
var COUNTER_BUTTON_CREATE = 'COUNTER_BUTTON_CREATE';
var COUNTER_BUTTON_ADD = 'COUNTER_BUTTON_ADD';

var counterButton_create = function counterButton_create(counterid) {
  return {
...
var counterButton_add = function counterButton_add(counterid, addvalue) {
  return {
...
exports.counterButton_create = counterButton_create;
exports.COUNTER_BUTTON_CREATE = COUNTER_BUTTON_CREATE;
exports.counterButton_add = counterButton_add;
exports.COUNTER_BUTTON_ADD = COUNTER_BUTTON_ADD;
...
var _MainPage = __webpack_require__(42);

var _MainPage2 = _interopRequireDefault(_MainPage);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_reactDom2.default.render(_react2.default.createElement(_MainPage2.default, null), document.getElementById('container'));
...
var _CounterButton = __webpack_require__(73);
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(_CounterButton2.default, { counterid: 111 }),
                    _react2.default.createElement(_CounterButton2.default, { counterid: 222 })
                )
            );
        }
    }]);
...
var _counterButtonReducer = __webpack_require__(72);

var _counterButtonReducer2 = _interopRequireDefault(_counterButtonReducer);
...
var combinedReducer = (0, _redux.combineReducers)({
    ...
    counterButton: _counterButtonReducer2.default
    // + другие редьюсеры
});
...
var _counterButtonAC = __webpack_require__(29);
...
};function counterButtonReducer() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : initState;
  var action = arguments[1];

  switch (action.type) {

    case _counterButtonAC.COUNTER_BUTTON_CREATE:
      {
        ...
        var newState = _extends({}, state, {
          counters: _extends({}, state.counters, _defineProperty({}, action.counterid, 0))
        });
        console.log('state после обработки редьюсером:', newState);
        return newState;
      }

    case _counterButtonAC.COUNTER_BUTTON_ADD:
      {
        console.log('action:', action);
        console.log('state до обработки редьюсером:', state);
        var _newState = _extends({}, state, {
          counters: _extends({}, state.counters, _defineProperty({}, action.counterid, state.counters[action.counterid] + action.addvalue))
        });
        console.log('state после обработки редьюсером:', _newState);
        return _newState;
      }
...
exports.default = counterButtonReducer;
...
var intCounterButton = function (_React$PureComponent) {
  _inherits(intCounterButton, _React$PureComponent);

  function intCounterButton() {
    var _ref;

    var _temp, _this, _ret;

    _classCallCheck(this, intCounterButton);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = intCounterButton.__proto__ || Object.getPrototypeOf(intCounterButton)).call.apply(_ref, [this].concat(args))), _this), _this.incCounter = function () {
      _this.props.dispatch((0, _counterButtonAC.counterButton_add)(_this.props.counterid, 1));
    }, _this.decCounter = function () {
      _this.props.dispatch((0, _counterButtonAC.counterButton_add)(_this.props.counterid, -1));
    }, _temp), _possibleConstructorReturn(_this, _ret);
  }

  _createClass(intCounterButton, [{
    key: 'componentWillMount',
    value: function componentWillMount() {
      // изначально счётчика с идентификатором counterid нет
      // создадим
      this.props.dispatch((0, _counterButtonAC.counterButton_create)(this.props.counterid));
    }
  }, {
    key: 'render',
    value: function render() {
      ...
      var counterValue = this.props.counterButton.counters[this.props.counterid];

      return _react2.default.createElement(
        'div',
        { className: 'CounterButton' },
        _react2.default.createElement('input', { type: 'button', value: '-', onClick: this.decCounter }),
        _react2.default.createElement(
          'span',
          { className: 'CounterButtonValue' },
          counterValue
        ),
        _react2.default.createElement('input', { type: 'button', value: '+', onClick: this.incCounter })
      );
    }
  }]);

  return intCounterButton;
}(_react2.default.PureComponent);

intCounterButton.propTypes = {
  counterid: _propTypes2.default.number.isRequired, // передано из родительского компонента
  counterButton: _propTypes2.default.object.isRequired // передано из Redux
};
...
var CounterButton = (0, _reactRedux.connect)(mapStateToProps)(intCounterButton);
